...
if ($MyInvocation.ExpectingInput) {
    ...
    $input | java -jar cli/target/scala-3.8.3/cli-app-assembly-0.1.0-SNAPSHOT.jar @args
} else {
    # If no piped input, just run Java with arguments
    java -jar cli/target/scala-3.8.3/cli-app-assembly-0.1.0-SNAPSHOT.jar @args
}
